                    ...
                    <div className="flex flex-col gap-2 p-5">
                        ...
                        <nav className="hs-accordion-group w-full flex flex-col flex-wrap mt-4" data-hs-accordion-always-open>
                            <ul className="space-y-1.5">
                                ...
                                <li>
                                    <Link className={isActiveNav('/buses')} href={redirectToRoute('/buses')}>
                                ...
                                <li>
                                    <Link className={isActiveNav('/bus-schedules')} href={redirectToRoute('/bus-schedules')}>
                                ...
                                <li>
                                    <Link className={isActiveNav('/jobs')} href={redirectToRoute('/jobs')}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                                ...
                                <li>
                                    <Link className={isActiveNav('/applicants')} href={redirectToRoute('/applicants')}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
