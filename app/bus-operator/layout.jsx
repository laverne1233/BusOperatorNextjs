...
export default function BusOperatorLayout({ children }) {
    ...
    const isActiveNav = (uri) => {
        return pathname.includes(`/bus-operator${uri}`) ?
    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex flex-col gap-2 p-5">
                        ...
                        <nav className="hs-accordion-group w-full flex flex-col flex-wrap mt-4" data-hs-accordion-always-open>
                            <ul className="space-y-1.5">
                                ...
                                <li>
                                    <Link className={isActiveNav('/notification')} href={redirectToRoute('/notification')}>
                                ...
                                <li>
                                    <Link className={isActiveNav('/bus')} href={redirectToRoute('/bus')}>
                                ...
                                <li>
                                    <Link className={isActiveNav('/employee')} href={redirectToRoute('/employee')}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                                ...
                                <li>
                                    <Link className={isActiveNav('/bus-schedule')} href={redirectToRoute('/bus-schedule')}>
                                ...
                                <li>
                                    <Link className={isActiveNav('/applicant')} href={redirectToRoute('/applicant')}>
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                ...
                <div className="w-full md:w-5/6 border border-8 border-purple-default bg-gray-100">
                    {children}
                </div>
            </div>
            <PrelineScript />
