...
const UserInformation = () => {
    ...
    return (
        <div className='flex flex-col gap-5'>
            ...
            <div>
                <input type="email" id="email" name="email" className="py-3 px-4 pr-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Email Address" onChange={(e) => setAddress(e.target.value)} />
            ...
            <div className="relative">
                <input type={showPassword ? "text" : "password"} id="confirmPassword" name="confirmPassword" className="py-3 px-4 pr-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Confirm Password" />
                <button
                    className="absolute inset-y-0 end-0 flex items-center pointer-events-auto z-20 pr-4"
                    onClick={() => setShowPassword((showPassword) => !showPassword)}
                >
            ...
            <div>
                <input type="number" id="phoneNumber" name="phoneNumber" className="py-3 px-4 pr-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Contact Number" onChange={(e) => setAddress(e.target.value)} />
                {/* {errors?.address && <span className='text-sm text-red-500'>{errors.address[0]}</span>} */}
            </div>

            <div className='flex flex-col gap-2'>
                <button type='button' className='bg-red-500 text-white rounded-lg py-2 px-4  w-full' onClick={decreaseStep}>Back</button>
    ...
    return (
        <>
            <div className='flex items-center justify-center h-screen'>
                <div className="bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7] p-4 w-4/6 h-5/6">
